...
public class ViewItemCreateReq_SM extends javax.swing.JFrame {
    ...
    public ViewItemCreateReq_SM(String loggedInUser,InventoryController inventoryController) {
    ...
    public ViewItemCreateReq_SM(InventoryController inventoryController){
        if (inventoryController == null) {
        System.out.println("InventoryController is NULL in constructor!");
    } else {
        System.out.println("InventoryController is initialized");
    ...
    private void initComponents() {
        ...
        showReorderBtn1 = new javax.swing.JButton();
        ...
        jPanel1.add(refreshButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 390, -1, -1));
        ...
        jPanel1.add(itemReorderLevel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 520, 240));

        showReorderBtn1.setText("Show only need Reorder");
        showReorderBtn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                showReorderBtn1ActionPerformed(evt);
            }
        });
        jPanel1.add(showReorderBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 440, -1, -1));
    ...
    if (itemId.isEmpty()) {
        try {
            ...
            itemReorderLevel1.populateItems(allItems); // Assuming this method accepts a list of items
        } catch (Exception e) {
        ...
        try {
            ...
            // Update the itemReorderLevel1 table with the found item
                itemReorderLevel1.populateItems(Collections.singletonList(item)); 
            }
        } catch (Exception e) {
    ...
    private void searchItemNameBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchItemNameBtnActionPerformed
       String itemName = itemNameSearch.getText().trim(); // Get the item name from the search field
        ...
        if (itemName.isEmpty()) {
            ...
            // Update the table with all items
            itemReorderLevel1.populateItems(allItems);
    ...
    java.awt.EventQueue.invokeLater(() -> {
            ...
            ViewItemCreateReq_SM frame = new ViewItemCreateReq_SM(inventoryController);
    ...
    private javax.swing.JButton showReorderBtn1;
