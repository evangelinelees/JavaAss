...
import javaassignment.InventoryManager.Forms.PaymentOrder;
                ...
                formToShow = switch (index) {
                    ...
                    case 1 -> {
                        yield switch (subIndex) {
                            ...
                            case 2 -> new PaymentOrder( inventoryController, itemInputPanel, itemDao, loggedInUser, purchaseOrderDao);
                            default -> new DefaultForm("Inventory Form: " + subIndex);
                        };
                    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(body, javax.swing.GroupLayout.DEFAULT_SIZE, 1044, Short.MAX_VALUE))
